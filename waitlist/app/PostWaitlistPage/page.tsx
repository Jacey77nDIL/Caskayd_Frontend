...
export default function FlipFormPage() {
  ...
  return (
    <main className={`${inter.className} min-h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('/bg.jpg')}}`}>
      ...
      <div className="relative bg-black backdrop-blur-sm w-[650px] h-[433px] max-w-none rounded-xl p-6 text-white shadow-xl">
        ...
        <p className="text-[26px] font-extralight max-w-[800px] mb-6 text-center">
